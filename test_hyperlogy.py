#!/usr/bin/env python3
"""
Test script specifically for Hyperlogy to verify the new strict career page filtering logic
"""
...
def test_hyperlogy():
    """Test the new strict career page filtering with Hyperlogy"""
    
    url = "https://www.hyperlogy.com/en/"
    api_url = "https://crawler-ai.fly.dev/crawl_and_extract_contact_info"
    
    print("🧪 Testing STRICT Career Page Filtering with Hyperlogy")
    print("=" * 60)
    print(f"🔍 Testing: {url}")
