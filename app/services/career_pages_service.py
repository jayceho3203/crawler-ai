...
# from .scrapy_career_spider import run_optimized_career_spider  # Temporarily disabled for Python 3.13
    ...
    async def detect_career_pages(self, url: str, include_subdomain_search: bool = False,
        ...
        try:
            ...
            if use_scrapy:
                ...
                logger.info("⚠️ Scrapy temporarily disabled - waiting for Python 3.11.9 deployment")
